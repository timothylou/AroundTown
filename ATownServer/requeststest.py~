...
eventdict = {'latitude': 0.0, 'longitude': 1.1, 'title': 'birthday party', 'description': 'its lit', 'cat': 9, 'oid': 'uiduiduiduid', 'netid': 'tlou', 'stime': '00:54', 'dur': 60}
...
print "Check posting event info"
eventdict = {'latitude': 2.2, 'longitude': 3.3, 'title': 'free food', 'description': 'its lit', 'cat': 9, 'oid': 'uiduiduiduid', 'netid': 'tlou', 'stime': '00:54', 'dur': 60}
r = requests.post('http://ec2-54-167-219-88.compute-1.amazonaws.com/post/newevent/', data=json.dumps(eventdict))
eventid = r.text
print eventid
print
...
print "Check posting event info"
eventdict = {'latitude': 4.4, 'longitude': 5.5, 'title': 'free showing', 'description': 'its lit', 'cat': 9, 'oid': 'uiduiduiduid', 'netid': 'tlou', 'stime': '00:54', 'dur': 60}
r = requests.post('http://ec2-54-167-219-88.compute-1.amazonaws.com/post/newevent/', data=json.dumps(eventdict))
eventid = r.text
print eventid
print
